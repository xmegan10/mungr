...
The `MungrCleaner` S3 object holds the raw data, applies modifications through generic methods, and maintains a detailed log of every operation. Here are the key methods:
